...
export const COLUMNS: ColumnDef[] = [
  ...
  },
  {
    ...
    type: "readonly",
    isPopulated: (e) => !!e.date_posted,
    getDisplay: (e) => dateParts(e.date_posted).monthName,
  },
  {
    ...
    type: "readonly",
    isPopulated: (e) => !!e.date_posted,
    getDisplay: (e) => dateParts(e.date_posted).monthYear,
  },
  {
    key: "posted_year",
    label: "Posted Year",
    type: "readonly",
    isPopulated: (e) => !!e.date_posted,
    getDisplay: (e) => dateParts(e.date_posted).year,
  },
  {
    key: "posted_cy_py",
    label: "Posted CY/PY",
    type: "readonly",
    isPopulated: (e) => !!e.date_posted,
    getDisplay: (e) => dateParts(e.date_posted).cyPy,
  },
];
